...
{
    public class IntCodeComputer_Day09_Tests
    {
        private readonly IntCodeComputer_Day09 _intCodeComputer;

        public IntCodeComputer_Day09_Tests()
        {
            _intCodeComputer = new IntCodeComputer_Day09();
        }
