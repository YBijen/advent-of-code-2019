...
namespace AdventOfCode.Solutions.Year2019
{
    public class Day05_Tests
    {
        ...
        public void Test_HandleInput()
        {
            ...
            _day05.DebugProgramInputModifier = "1";

            var output = _day05.HandleProcessInput(program, 0);
        ...
        public void Test_Part2_AoCExamples(string programInput, string inputModifier, string expectedOutput)
        {
            _day05.DebugProgramInputModifier = inputModifier;
            _day05.DebugInput = programInput;
            Assert.Equal(expectedOutput, _day05.Part2);
        }
    }
}
